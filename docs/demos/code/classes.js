...
function class11() { 
        document.write(`
<category name="Class11 Draw Lines "colour="%{BKY_PROCEDURES_HUE}">  
   <block type="debugcode"></block>
   <category name="Sound" colour="%{BKY_COLOR_HUE}">
      <block type="playsound"></block>
      <block type="mixerbusy"></block>
...
function class12() { 
        document.write(`
<category name="Class12 Sprite Sheet "colour="%{BKY_PROCEDURES_HUE}">  
   <block type="debugcode"></block>
   <category name="Sound" colour="%{BKY_COLOR_HUE}">
      <block type="playsound"></block>
      <block type="mixerbusy"></block>
...
function class13() { 
        document.write(`
<category name="Class13 Jeb Color "colour="%{BKY_PROCEDURES_HUE}">  
   <block type="debugcode"></block>
   <category name="Sound" colour="%{BKY_COLOR_HUE}">
      <block type="playsound"></block>
      <block type="mixerbusy"></block>
