...
Blockly.Python.finish=function(a){
 ...
 var imports = 
    ...
    "   obj.hCount = hCount\n" + 
    "   obj.vCount = vCount\n" +     
    "   obj.width = int(width / hCount)\n" + 
    "   obj.height = int(height / vCount) \n" + 
    "   obj.totalImages = totalImages\n" +     
    "   obj.index = 0\n" + 
    "   obj.doneSequence = False\n" + 
    "   obj.displayTime = 0\n" + 
    ...
    "      if i in indexList:\n" + 
    "         print ( str(i) + ' is in : ' + str(indexList))\n" + 
    ...
    "   # print (\"nextListItem [list.index,value]: [\" + str(list.index) + \",\" + str(value) + \"]\" )\n" + 
    "   return value\n" + 
    "def nextColor (jeb):\n" +
